...
function preload() {
  headerFont = textFont('Helvetica') //  loadFont('/resources/VTCBayard-Regular.ttf');
  ...
  myFont3 = textFont('Helvetica') // loadFont('/resources/Karla-Bold.ttf');
  myFont4 = textFont('Helvetica') // loadFont('/resources/Rubik-Regular.ttf');
